module.exports = {
  siteTitle: 'Pine Knoll Consulting',
  siteTitleAlt: 'Neil Swinton Site and Blog', // This allows an alternative site title for SEO schema.
  ...
  copyright: 'Copyright © 2019 Neil Swinton', // Copyright string for the RSS feed
}
